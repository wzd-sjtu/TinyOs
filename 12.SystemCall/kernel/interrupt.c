...
extern uint32_t syscall_handler(void); // will be definede in kernel.S
...
static void idt_desc_init(void) {
   ...
   make_idt_desc(&idt[lastindex], IDT_DESC_ATTR_DPL3, syscall_handler); // singlely process the interrupt
